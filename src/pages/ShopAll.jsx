            ...
            <div className="mt-8">
                ...
                <div className="flex flex-wrap justify-center gap-3 mt-4">
                    <button
                        ...
                        className={`px-5 py-2 rounded-full shadow-md font-medium ${
                            selectedBrand === null ? "bg-black text-white" : "bg-gray-200"
                        }`}
                    >
                        All Brands
                    </button>
                    {uniqueBrands.map((brand, index) => (
                        <button
                            ...
                            key={index}
                            className={`px-5 py-2 rounded-full shadow-md font-medium transition-transform duration-300 ${
                                selectedBrand === brand ? "bg-blue-500 text-white" : "bg-gray-200"
                            }`}
                        >
                            {brand}
                        </button>
